...
const SECTIONS: { label: string; audience: string; items: FAQ[] }[] = [
  {
    ...
    items: [
      ...
      { q: "Can I get teak and Central American Cypress in the same shipment?", a: "Yes. We stage both species domestically. Mixed pallet orders are standard." },
      ...
      { q: "How is the lumber graded?", a: "We use our own published grade specs, aligned with NHLA standards where applicable. Teak grades: FEQ (First European Quality), Select/Better, Standard. Central American Cypress grades: Select, #1 Common, Rustic/Pecky. Grade spec sheets available from the trade desk — we don't hide what you're buying." },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Is Central American Cypress actually better than cedar for closets?", a: "For moth repellency and aromatic longevity, yes. Cedar's aromatic compounds fade in 3–5 years. Central American Cypress contains alpha-pinene and cypressine, which provide moth repellency for 5–10 years. It is also harder (900–1,100 lbf vs. cedar's 350 lbf) — it won't dent from hangers or shelving hardware." },
      { q: "Can I install teak or Central American Cypress as a DIY project?", a: "Teak requires carbide-tipped blades and pre-drilling for fasteners — workable for a skilled DIYer but not beginner territory. Central American Cypress is much easier: it planes, cuts, and nails similarly to domestic softwood. For decking and fencing, always recommend a licensed contractor for fastener spec and structural attachment." },
      { q: "Is the wood sustainably sourced?", a: "Yes, with documentation. All teak and Central American Cypress comes from plantation growers in Costa Rica — not old-growth tropical forest. Costa Rica achieved net-zero deforestation. Our teak is CITES Appendix II compliant. Our Central American Cypress is managed under SINAC oversight. We can provide chain-of-custody documentation for any order." },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "What are the dimensional stability specs for interior applications?", a: "Teak: 2.5% radial, 4.0% tangential shrinkage coefficients — among the lowest of any commercial hardwood. For interior cladding in conditioned spaces, movement is minimal. Central American Cypress: slightly higher at 3.4% radial, 6.2% tangential. Both species should be acclimated to job-site conditions for 7–14 days before installation." },
      { q: "Can Central American Cypress be specified for exterior siding in cold climates?", a: "Yes, with correct detailing. Central American Cypress rates USDA Class 2–3 (above-grade) decay resistance — appropriate for vertical siding, rainscreen, soffit, and fascia applications. Not recommended for ground-contact. In freeze-thaw climates: proper back-priming, 1/4 inch reveal gaps at butt joints, and drainable cladding details. Same detailing requirements as western red cedar." },
      { q: "What are the knot specifications for Select and #1 Common Central American Cypress?", a: "Select: clear or near-clear — occasional tight pin knots permitted, no loose knots. #1 Common: sound, tight knots up to 1 inch diameter permitted. No loose, dead, or through knots in either grade. Rustic/Pecky grade includes natural pecky pockets — a character feature for interior feature wall applications." },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "What's CAFTA-DR and why does it matter for pricing?", a: "CAFTA-DR (Dominican Republic–Central America Free Trade Agreement) eliminates import duty on Costa Rican lumber entering the US. Teak and Central American Cypress both enter at 0% tariff under HTS code 4407. That eliminates the 5–10% duty that applies to teak from other origins. We pass those savings directly to buyers." },
